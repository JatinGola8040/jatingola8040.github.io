  ...
  return (
    ...
    <div className="container-intro">
      <section className={`big-card ${state.darkmode ? "dark-card" : "light-card"}`}>
        <h2 className={`${state.darkmode ? "dark-heading" : "light-heading"}`}>{state.language === "english" ? "React-Entwickler an der Schnittstelle von Design und Code." : "Python Developer with Passion in AI and Machine Learning"}</h2>
